...
public class S125DatasetInfo {
     ...
     */
    public S125DatasetInfo(String datasetId, String agency, List<AtonNode> atonNodes) {
        ...
        this.language = "en";
        this.abstractText = "Autogenerated S-125 Dataset for" + Optional.ofNullable(atonNodes)
