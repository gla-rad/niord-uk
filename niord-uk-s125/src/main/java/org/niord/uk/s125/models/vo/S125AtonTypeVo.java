 ...
 */
package org.niord.uk.s125.models.vo;
...
/**
 * The S-125 AtoN Feature Type Vo Class.
 * <p>
 * This is a VO object to transfer the information about the currently
 * supported S-125 feature type entries.
 *
 * @author Nikolaos Vastardis (email: Nikolaos.Vastardis@gla-rad.org)
 */
public class S125AtonTypeVo {
     ...
     */
    public S125AtonTypeVo(S125AtonTypes s125AtonTypes) {
    ...
    /**
     * Translates the object back into the S-125 AtoN Types enum.
     *
     * @return the respective S-125 AtoN Types enum entry
     */
    public S125AtonTypes getS125AtonType() {
        return S125AtonTypes.fromSeamarkType(this.getName());
    }
}
