...
/**
 * The S-201 AtoN Types Enum.
 * <p>
 * This enumeration can be used to determine the types of AtoN that are
 * provided through Niord as AtonNodes. They will determine which S-201
...
public enum S201AtonTypes {
    ...
    S201AtonTypes(String name, String description, boolean equipment, String[] jomsNodeTypes) {
        this.name = name;
     ...
     */
    public static S201AtonTypes fromSeamarkType(String type) {
