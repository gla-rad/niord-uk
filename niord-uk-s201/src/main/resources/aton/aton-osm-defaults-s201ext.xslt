...
<xsl:stylesheet
    ...
    <xsl:template match="group[@name='Seamarks' or ancestor-or-self::group[@name='E: Landmarks' or @name='L: Offshore Installations' or @name='M: Tracks, Routes' or @name='P: Lights' or @name='Q: Buoys, Beacons, Notices' or @name='R: Fog Signals' or @name='S: Electronic Position-Fixing Systems']]">
    ...
    <xsl:template match="chunk[ @id='categoryOfPhysicalAISAidToNavigation' or @id='categoryOfSyntheticAISAidToNavigation' or @id='marksNavigationalSystemOf' or @id='categoryOfBuildingShape' or @id='atonStatus' or @id='shackleType' or @id='categoryOfPowerSource' or @id='aidAvailabilityCategory' or @id='condition']">
        <tag-values>
            <xsl:attribute name="id">
                <xsl:value-of select="@id"/>
            </xsl:attribute>
